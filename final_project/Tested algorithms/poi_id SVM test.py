...
features_list = ['poi', 'salary', 'deferral_payments', 'total_payments',
 ...
 'long_term_incentive', 'restricted_stock', 'director_fees',
  ...
  'from_this_person_to_poi', 'shared_receipt_with_poi', 'bonus_to_salary',
                 'ratio_to_poi', 'ratio_from_poi', 'number_info']
...
while n_components < 19:
    ...
    for train_index, test_index in sss.split(features, labels):
        ...
        pipeline = Pipeline([('reduce_dim', PCA(n_components=n_components)),
        ...
        #
        # #print "Feature importances: ", pipeline.steps[0][1].feature_importances_
        #
    ...
    print "n_components: ", n_components, "\tAccuracy mean: ", np.mean(
            accuracy_list), "\tPrecision mean: ", \
        np.mean(precision_list), "\tRecall mean: ", np.mean(recall_list)
...
#
# print "Feature importances: ", pipeline.steps[2][1].feature_importances_
#
# print "Accuracy: ", accuracy_score(labels_test, pred)
#
# print "Precision score: ", precision_score(labels_test, pred)
